...
async function burnSubtitleGPU(inputFile, outputFile) {
  return new Promise((resolve, reject) => {
    ...
    const ffmpegArgs = [
      ...
      // '-to', '01:19:25',
      // scale=-1:1080
      '-vf', "subtitles=JD_EP25_INDO.ass,drawtext=text='DongWorld':font=Verdana:fontsize=30:fontcolor=white@0.5:x=15:y=15",
      '-c:v', 'libx264',
      '-crf', '25',
...
burnSubtitleGPU('JD_EP25.mp4', 'JD_EP25_INDO.mp4')